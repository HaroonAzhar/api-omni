    ...
    return waterfall(
      [
        ...
        (results: request.Response, cb: request.CallbackHandler) => {
          ...
          const { landRegistry } = furtherAdvance.originationChecklist;
        ...
        (results: request.Response, cb: request.CallbackHandler) =>
          request(server)
            .post(
              `/cases/${caseId}/completed/furtherAdvances/${furtherAdvanceId}/originationChecklist/landRegistry/primarySignature`
            )
        ...
        (results: request.Response, cb: request.CallbackHandler) =>
          request(server)
            .post(
              `/cases/${caseId}/completed/furtherAdvances/${furtherAdvanceId}/originationChecklist/landRegistry/secondarySignature`
            )
        ...
        (results: request.Response, cb: request.CallbackHandler) =>
          request(server)
            .post(
              `/cases/${caseId}/completed/furtherAdvances/${furtherAdvanceId}/originationChecklist/landRegistry/results`
            )
