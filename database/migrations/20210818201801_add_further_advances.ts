...
exports.up = async (knex: Knex) => {
  await knex.schema.createTable("Servicing.FurtherAdvances", (table) => {
    table.increments("FurtherAdvanceId").primary();
...
exports.down = async (knex: Knex) => {
  await knex.schema.dropTable("Servicing.FurtherAdvances");
};
